...
| 견적 조건 (`quote`) | 주문수량 10,000개 · FOB (Busan, Korea) · 목표 영업마진 20% · 최소 영업마진 15% · 바이어 목표가 $2.35 (`margin-target`) |
...
- 연동 결과: 원가 합계 3,173 × 1.03 = **3,268원**, 209카톤 · **3.14 CBM**. 기준 환율은 바꾸지 않습니다(상단 `margin-fx` 값 유지).
