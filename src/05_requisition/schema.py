...
SECTIONS = [
    ...
    ("05 품질 확인사항", [
        ...
        ("quality.skin_irritation.required", "피부자극 테스트", "required"),
        ("quality.skin_irritation.duration", "피부자극 기간", "text"),
        ("quality.skin_irritation.responsibility", "피부자극 책임 주체", "text"),
        ("quality.eye_irritation.required", "안자극 테스트", "required"),
        ("quality.eye_irritation.duration", "안자극 기간", "text"),
        ("quality.eye_irritation.responsibility", "안자극 책임 주체", "text"),
        ("quality.sensory.required", "관능 테스트", "required"),
        ("quality.sensory.duration", "관능 테스트 기간", "text"),
        ("quality.sensory.responsibility", "관능 테스트 책임 주체", "text"),
        ("quality.clinical.required", "임상 테스트", "required"),
        ("quality.clinical.duration", "임상 테스트 기간", "text"),
        ("quality.clinical.responsibility", "임상 테스트 책임 주체", "text"),
        ("quality.other_tests", "기타 테스트", "textarea"),
    ]),
]
